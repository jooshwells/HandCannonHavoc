...
public class Crossbow : MonoBehaviour 
{
    ...
    void shoot()
    {
        ...
        GameObject arrow = Instantiate(bulletSprite, gunBarrel.position, gunPos.rotation);    
        SpriteRenderer bulletRenderer = arrow.GetComponent<SpriteRenderer>();
        if (bulletRenderer != null)
        {
            bulletRenderer.enabled = true; // Make the bullet visible
        }
        BombArrow bulletScript = arrow.GetComponent<BombArrow>();
