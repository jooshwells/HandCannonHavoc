...
public class RicochetGun : MonoBehaviour 
{
    ...
    void shoot()
    {
        ...
        SpriteRenderer bulletRenderer = bounce.GetComponent<SpriteRenderer>();
        if (bulletRenderer != null)
        {
            bulletRenderer.enabled = true; // Make the bullet visible
        }
        BounceBullet bulletScript = bounce.GetComponent<BounceBullet>();
